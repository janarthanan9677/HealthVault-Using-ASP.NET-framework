<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Addnurse.aspx.cs" Inherits="WebApplication6.Admin.Addnurse" %>
...
<asp:Button ID="btnBack" runat="server" Text="← Back to Dashboard" 
    ...
    <div class="form-container">
        ...
        <asp:Button ID="btnSave" runat="server" Text="Save Nurse" OnClick="btnSave_Click" CssClass="btn" /><br />
